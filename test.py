...
## ISTD
opt.dataroot_A = './ISTD_Dataset/test/test_A'
opt.im_suf_A = '.png'
opt.dataroot_B = './BDRAR/test_A_mask_istd_6/'
opt.im_suf_B = '.png'
opt.savename = ''
    ...
    for idx, img_name in enumerate(gt_list):
        ...
        with torch.no_grad():
            ...
            if test_448480:
                ...
                labimage448=labimage448.unsqueeze(0).cuda()
                ...
                mask448=mask448.unsqueeze(0).cuda()
                # mask0-1
